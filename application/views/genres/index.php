<div class="row">
          ...
          <div class="row">
            <div class="col-lg-6">
              <p>
                ...
                {
                    if($value['permission'] == 'genres')
                    {
                ?>
                <?php if($value['insert'] == 1)
                {
                ?>
                <a href="<?php echo base_url('genres/add/'); ?>" class="btn btn-default">Add New</a>
                <?php 
                }
                ?>
          ...
          <?php if($value['delete_all'] == 1)
            ...
            <div class="table-responsive">     
              <form method="post" action="<?php echo base_url('genres/delete_all/');?>">
...
?> 
                  <tr>
                    ...
                    {
                    ?>
                    <td><a href= "<?php echo base_url('genres/edit/').$row['id'];?>" > Edit </a>  |<?php } ?> 
                    <?php if($value['delete'] == 1)
                    {
                    ?>
                    <a href= "<?php echo base_url('genres/delete/').$row['id'];?>" onclick="return confirm('Are you sure you want to delete this data?');">  Delete </a> <?php } ?>
                  </tr>
<?php
        }
?>
...
<script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#search").click(function(){
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url('genres/search'); ?>',
